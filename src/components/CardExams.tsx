...
export const CardExams = ({average,espp,numberLeft}:any) => {
  return (
    ...
    <div className="bg-white flex rounded-3xl border shadow-xl p-8 w-3/6">
      ...
      <div>
        <h1 className="font-semibold text-xl text-gray-700 ml-5">Подаци о испитима</h1>
        <h1 className="font-semibold text-xl text-gray-500 ml-5">Просек: {" "+ average}</h1>
        <h1 className="font-semibold text-xl text-gray-500 ml-5">Број ЕСПБ: {" "+ espp}</h1>
        <h1 className="font-semibold text-xl text-gray-500 ml-5">Број неположених испита: {" "+ numberLeft}</h1>
      </div>
    </div>
  </div>
  );
